...
class Test_api(unittest.TestCase):
    ...
    def test_createFilename(self):
        ...
        time = None
        pattern = ''
        assert aida.createFilename(pattern, time) == ['']
        ...
        name = 'test'
        pattern = '{SS}{MM}{name}'
        assert aida.createFilename(pattern, time, name=name) == ['1234test']
